...
export function DitheringShader({
  ...
  useEffect(() => {
    ...
    const render = () => {
      ...
      if (l.u_time)       gl.uniform1f(l.u_time, t)
      if (l.u_resolution) gl.uniform2f(l.u_resolution, width, height)
      if (l.u_colorBack)  gl.uniform4fv(l.u_colorBack,  hexToRgba(colorBack))
      if (l.u_colorFront) gl.uniform4fv(l.u_colorFront, hexToRgba(colorFront))
      if (l.u_shape)      gl.uniform1f(l.u_shape,  DitheringShapes[shape])
      if (l.u_type)       gl.uniform1f(l.u_type,   DitheringTypes[type])
      if (l.u_pxSize)     gl.uniform1f(l.u_pxSize, pxSize)
