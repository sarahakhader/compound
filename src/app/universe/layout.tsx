...
export const metadata: Metadata = {
  ...
  description: "A real-time 3D city — six districts, each with its own material identity. Enter the Compound universe.",
  openGraph: {
    title:       "Compound World — COMPOUND",
    description: "A real-time 3D city — six districts, each with its own material identity.",
